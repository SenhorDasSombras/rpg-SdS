...
\begin{tabular}{
    ...
    \multicolumn{3}{|l|}{\textbf{\Large O Guerreiro}} \\
    ...
    \textbf{1º} & +2 & Estilo de Luta, Retomar o Fôlego \\
    \hline
    \textbf{2º} & +2 & Surto de Ação \\
    \hline
    \textbf{3º} & +2 & Arquétipo Marcial \\
    \hline
    \textbf{4º} & +2 & Incremento em Habilidade \\
    \hline
    \textbf{5º} & +3 & Ataque Extra \\
    \hline
    \textbf{6º} & +3 & - \\
    \hline
    \textbf{7º} & +3 & Arquétipo Marcial \\
    \hline
    \textbf{8º} & +3 & Incremento em Habilidade \\
    \hline
    \textbf{9º} & +4 & Indomável \\
    \hline
    \textbf{10º} & +4 & Arquétipo Marcial \\
    \hline
    \textbf{11º} & +4 & Ataque Extra \\
    \hline
    \textbf{12º} & +4 & Incremento em Habilidade \\
    \hline
    \textbf{13º} & +5 & Indomável \\
    \hline
    \textbf{14º} & +5 & - \\
    \hline
    \textbf{15º} & +5 & Arquétipo Marcial \\
    \hline
    \textbf{16º} & +5 & Incremento em Habilidade \\
    \hline
    \textbf{17º} & +6 & Indomável \\
    \hline
    \textbf{18º} & +6 & Arquétipo Marcial \\
    \hline
    \textbf{19º} & +6 & Incremento em Habilidade \\
    \hline
    \textbf{20º} & +6 & Ataque Extra, Precisão \\
    \hline
\end{tabular}
\end{center}
\begin{multicols}{2}
